...
echo "cd /root" >> /root/run-all-after-vm-booting.sh
echo "./copy_keygen.sh $TG_IP $USERNAME $PASSWD" >> /root/run-all-after-vm-booting.sh
echo "sleep 2" >> /root/run-all-after-vm-booting.sh
echo "./copy_keygen.sh $SUT_IP $USERNAME $PASSWD" >> /root/run-all-after-vm-booting.sh
echo "sleep 2" >> /root/run-all-after-vm-booting.sh
echo "./copy_keygen.sh 127.0.0.1 $USERNAME $PASSWD" >> /root/run-all-after-vm-booting.sh
echo "sleep 2" >> /root/run-all-after-vm-booting.sh
#==========================================================================
